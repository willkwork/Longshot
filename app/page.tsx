  ...
  return (
    <div className="flex flex-col min-h-screen font-sans bg-background">
      ...
      <motion.section
        ...
        className="bg-gray-950 py-16 px-6 text-center flex flex-col items-center gap-4 text-white"
      >
        ...
        <form className="mt-4 flex flex-col sm:flex-row gap-2 w-full max-w-md">
          <input
            ...
            className="flex-1 px-4 py-2 rounded border border-gray-600 bg-gray-900 text-white placeholder-gray-400"
          />
      ...
      <motion.section
        ...
        className="py-16 px-6 text-center flex flex-col items-center gap-4 bg-slate-900 text-white"
      >
        ...
        <div className="h-20 w-full bg-gray-900 flex items-center justify-center rounded">Logos Placeholder</div>
      ...
      <motion.section
        ...
        className="bg-gray-900 py-16 px-6 text-center flex flex-col items-center gap-4 text-white"
      >
      ...
      {/* Footer */}
      <footer className="mt-auto py-8 px-6 bg-gray-950 text-white flex flex-col items-center gap-4 text-sm">
        ...
        <form className="flex gap-2 w-full max-w-xs">
          <input
            ...
            className="flex-1 px-3 py-2 rounded bg-gray-900 border border-gray-600 text-white placeholder-gray-400"
          />
